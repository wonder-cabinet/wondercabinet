...
export const weeklyIssue = defineType({
  ...
  fields: [
    ...
    defineField({
      name: 'digestCoverImage',
      title: 'Digest: cover image (generated)',
      description: 'Auto-generated 1080×1350 Instagram-carousel cover slide for this week’s digest (the 52-week tracker + bilingual headline). Read-only — use the "Generate weekly digest" action.',
      type: 'image',
      readOnly: true,
    }),
    defineField({
      name: 'digestEnImage',
      title: 'Digest: English grid (generated)',
      description: 'Auto-generated 1080×1350 English event-grid slide, one column per day that has an event this week.',
      type: 'image',
      readOnly: true,
    }),
    defineField({
      name: 'digestArImage',
      title: 'Digest: Arabic grid (generated)',
    ...
    defineField({
      name: 'digestGeneratedAt',
      title: 'Digest generated at',
      type: 'datetime',
      readOnly: true,
    }),
    defineField({
